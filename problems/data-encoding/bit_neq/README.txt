...
For this problem, you need to implement a bitwise inequality function in C.
This takes two ints and returns 1 if they are not equal and 0 if they are.
...
You cannot use other operators, function calls, conditionals, or loops.
